...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>IMP_DlrshpNeed_Set_Migration_ID</fullName>
        <field>Migration_ID__c</field>
        <formula>Id + &apos;:&apos; + $Setup.CustomSettings__c.SF_Instance_Identifier__c</formula>
        <name>IMP_DlrshpNeed_Set_Migration_ID</name>
