...
&quot;3. Ensure the SEO AP in Salesforce is updated with the Webmaster Tools account it is now listed under.&quot;</formula>
    ...
    <rules>
        ...
        <formula>NOT(Begins($User.Username, $Setup.GlobalSettings__c.Admin_Integration_Username__c) ) &amp;&amp; OR( (RecordTypeId = &apos;01240000000ICTa&apos;), (RecordTypeId = &apos;01240000000ICU6&apos;) ) &amp;&amp;  OR( (isPickval( Problem_Code__c, &apos;Redesign&apos;)) , (ISPICKVAL( Program__c , &apos;Enhanced Design Options&apos;)) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>$RecordType.Name = &quot;IFS - Enhancements&quot; &amp;&amp; (ISPICKVAL(Type,&quot;GM Franchise&quot;)|| ISPICKVAL(Type,&quot;Non-GM Franchise&quot;))&amp;&amp; NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;))&amp;&amp; NOT(ISPICKVAL(Product_Order_Category__c,&quot;AMA&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>AND(NOT(Begins($User.Username, $Setup.GlobalSettings__c.Admin_Integration_Username__c)),  $RecordType.Name = &quot;IFS - Enhancements&quot;,  ISPICKVAL(Type, &quot;HMA Ghost Site&quot;),  ISPICKVAL(Type, &quot;Enhancement Products&quot;),  ISPICKVAL(Type, &quot;GM Fleet/Commercial&quot;),  ISPICKVAL(Type, &quot;VW Service Xpress&quot;),  AND(ISPICKVAL(Type, &quot;Budget Change&quot;)),  NOT(ISPICKVAL( Product_Order_Category__c , &quot;AMA&quot;))  )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
