...
&quot;Closed Won&quot;
  ...
  Adminstrators_Involved__c
    ...
    <rules>
        ...
        <description>Set &apos;Request: Date/Time Closed&apos; to Now() when Status change to &apos;Closed&apos;.</description>
    ...
    <rules>
        ...
        <description>Set &apos;Request: Date/Time Closed&apos; to Null when Status change not equal to &apos;Closed&apos;.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>CB_Request_DateTime_Completed_in_FullDev</fullName>
    ...
    <rules>
        ...
        <description>Notification to Request Creator when their Request has been closed</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
