...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND  (  NOT(Begins($User.Username, $Setup.GlobalSettings__c.Admin_Integration_Username__c)), OR(  INCLUDES(Product_Type__c,&quot;POWER SEO&quot;),  INCLUDES(Add_Ons__c,&quot;POWER SEO&quot;)),  NOT(ISBLANK(PowerSEO_Specialist__c)) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>NOT(Begins($User.Username, $Setup.GlobalSettings__c.Admin_Integration_Username__c))&amp;&amp; $RecordType.Name = &quot;SM/RM Launch&quot; &amp;&amp; Do_Not_Send_Onboarding__c = FALSE &amp;&amp; Send_Onboarding__c = FALSE &amp;&amp; ISPICKVAL(Status__c, &quot;Order Closed Waiting on Data&quot;) &amp;&amp; ISBLANK(Order_Closed_Waiting_on_Data_Date__c ) &amp;&amp; (INCLUDES( Product_Type__c , &quot;GM Social Media Essentials&quot;) || INCLUDES( Product_Type__c , &quot;Social Media Essentials&quot;) || INCLUDES( Product_Type__c , &quot;GM Power Social Media&quot;) || INCLUDES( Product_Type__c , &quot;Power Social Media Management&quot;) || INCLUDES( Product_Type__c , &quot;Power Reputation Management&quot;) || INCLUDES( Product_Type__c , &quot;GM Power Reputation Management&quot;) || INCLUDES( Product_Type__c , &quot;Reputation Management&quot;) || INCLUDES( Product_Type__c , &quot;GM Power Social Media&quot;) || INCLUDES( Product_Type__c , &quot;Social Media - Essentials&quot;) || INCLUDES( Product_Type__c , &quot;Social Media - Power&quot;)|| INCLUDES( Product_Type__c , &quot;RM DAP 5 Star Ads; &quot;) || INCLUDES( Product_Type__c , &quot;RM DAP 5 Star Video&quot;))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
...
Send_Onboarding__c = FALSE 
    ...
    <rules>
        ...
        <formula>(Open_Status__c = &quot;Closed&quot; &amp;&amp;  NOT(BEGINS($User.Username,&quot;integration_user@adp.com&quot;)) &amp;&amp;  Do_Not_Send_Onboarding__c = FALSE &amp;&amp;  ISBLANK(Order_Closed_Waiting_on_Data_Date__c)) &amp;&amp;  $RecordType.Name &lt;&gt; &quot;Website Launch&quot; &amp;&amp;  $RecordType.Name &lt;&gt; &quot;DAP Launch&quot; &amp;&amp;  $RecordType.Name &lt;&gt; &quot;Search Products Launch&quot; &amp;&amp;  $RecordType.Name &lt;&gt; &quot;A La Carte Launch&quot;&amp;&amp;  $RecordType.Name &lt;&gt; &quot;AMA Launch&quot;&amp;&amp; $RecordType.Name &lt;&gt; &quot;OEM Initiated Changes&quot; &amp;&amp;   Send_Onboarding__c =FALSE  ||  ($RecordType.Name = &quot;SM/RM Launch&quot; &amp;&amp;  ((ISPICKVAL(Status__c, &quot;Order Closed Waiting on Data&quot;) ||  ISPICKVAL(Status__c, &quot;Oracle Order Closed&quot;)) &amp;&amp;  ISBLANK(Order_Closed_Waiting_on_Data_Date__c ))&amp;&amp;  Do_Not_Send_Onboarding__c = FALSE &amp;&amp;  Send_Onboarding__c =FALSE  )  ||  ($RecordType.Name = &quot;Email Marketing Launch&quot; &amp;&amp;  (ISPICKVAL(Status__c, &quot;Oracle Order Closed&quot;) &amp;&amp;  ISBLANK(Order_Closed_Waiting_on_Data_Date__c))&amp;&amp;  Send_Onboarding__c =FALSE  )  ||  ($RecordType.Name = &quot;PowerSEO Launch&quot; &amp;&amp;  Open_Status__c = &quot;Closed&quot;&amp;&amp;  Send_Onboarding__c =FALSE  )  ||  ($RecordType.Name = &quot;A La Carte Launch&quot; &amp;&amp;  Open_Status__c = &quot;Closed&quot;&amp;&amp;  (  INCLUDES(Product_Type__c,&quot;Dealer Group Support&quot;)||  INCLUDES(Product_Type__c,&quot;Group Account Management&quot;)  )&amp;&amp;  Send_Onboarding__c =FALSE  )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
